...
internal sealed record TablesToIndexesMapping : ICell
{
    private readonly (ITable table, IIndex index) _tuple;

    private readonly IColumn _column;

    public TablesToIndexesMapping((ITable table, IIndex index) tuple, IColumn column)
    {
        _tuple = tuple;
        _column = column;
    }
        ...
        new CellMapping<IColumn>(
            ...
            [
                ...
                new KeyValuePair<IColumn, ICell>(
                    ...
                    new Cell(new HexString(new IndexHash(_tuple.index)))
                ),
                new KeyValuePair<IColumn, ICell>(
